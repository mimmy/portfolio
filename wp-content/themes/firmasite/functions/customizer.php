 ...
 */	?>
	...
	jQuery(document).ready(function() {
		...
		if (isset($data["content"])) echo $data["content"]; ?>" data-original-title="<?php if (isset($data["title"])) echo $data["title"]; ?>"><span class="btn btn-info btn-xs">?</span></a>');
		<?php } ?>
...
function firmasite_customizer_preview_init() {
	...
	wp_localize_script( 'firmasite_customizer', 'firmasite_settings_array', esc_js($firmasite_settings) );
